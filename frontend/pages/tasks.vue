<template>
  <div>
    ...
    <div class="tasks-header mb-8">
      <h1 class="text-3xl font-bold text-white mb-6">Tasks</h1>
    ...
    <div v-else-if="filteredTasks.length === 0" class="flex flex-col items-center justify-center py-20 mb-10">
      ...
      <NuxtLink to="/create" class="w-fit inline-flex items-center gap-2 px-5 py-2.5 bg-[#ffffff] text-[#000000] font-semibold rounded-md transition-colors duration-200 hover:bg-[#b0afaf] hover:text-[#000000]">
...
useHead({
  title: 'Tasks',
  meta: [
    { name: 'description', content: 'View and manage your tasks in a Kanban layout. Organize tasks by status: pending, ongoing, and completed.' },
    { property: 'og:title', content: 'Tasks | Task Manager' },
    { property: 'og:description', content: 'View and manage your tasks in a Kanban layout.' },
  ],
})
...
const filteredTasks = computed(() => {
  ...
  // Filter out tasks with multiple collaborators (for personal tasks view - show solo tasks and tasks where user is the only collaborator)
